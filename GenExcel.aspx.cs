...
namespace AmpelflowApp
{
    public partial class GenExcel : System.Web.UI.Page
    {
        ...
        string connString = ConfigurationManager.ConnectionStrings["Ampelflow"].ToString();
        string ssql = "";
        ...
        protected void excelonprint1job(object sender,EventArgs e)
        {
            ...
            using (SqlConnection sCon = new SqlConnection(connString))
            {
                ...
                sCom.Parameters.AddWithValue("@projectid", 10005);
                ...
                List<string> textHeader = new List<string> { "บริษัท แอมเพิลไลท์ เวิลด์", "ต้นทุนสินค้าราย JOB(ตามโครงการ)", "ชื่อโครงการ : " + ProjectName };
                ...
                Response.AddHeader("content-disposition", "attachment; filename=\"ยอดรวมต้นทุนรายโครงการ_" + ProjectName + ".xlsx\"");
        ...
        protected void exceltest(object sender,EventArgs e) 
        {
            ExcelPackage exc = new ExcelPackage();
            var workSheet = exc.Workbook.Worksheets.Add("Excel Testt");
            workSheet.Cells[1, 1, 1, 1].Value = "1000";
            workSheet.Cells[1, 1, 1, 1].Style.Numberformat.Format = "#,##0.00";
            ...
            //set the filename for the excel package
            Response.AddHeader("content-disposition", "attachment; filename=\"Testt"  + DateTime.Now.ToString() + ".xlsx\"");
        ...
        protected void excelonprintjoball(object sender,EventArgs e)
        {
            using (SqlConnection sCon = new SqlConnection(connString))
            {
        ...
        protected void excelcostinv(object sender,EventArgs e)
        {
