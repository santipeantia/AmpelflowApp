...
{
    /// <summary>
    /// Summary description for srv_usermanagement
    /// </summary>
    ...
    public class srv_usermanagement : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public void GetMemberEmployeeById(string empid)
        {
        ...
        [WebMethod]
        public void GetUserWithoutListById(string empid)
        {

            List<cGetEmployeeById> datas = new List<cGetEmployeeById>();
            SqlCommand comm = new SqlCommand("spGetUserWithoutListById", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
